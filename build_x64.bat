...
echo [INFO] Configuring x64 build environment...
call "!VS_PATH!\VC\Auxiliary\Build\vcvarsall.bat" x64

:: Execute build
echo [INFO] Compiling Nepgear (Release^|x64)...
msbuild "Nepgear.sln" /p:Configuration=Release /p:Platform=x64 /t:Rebuild /m
